...
- 全站 UI 重构（Stitch 设计稿 1:1 还原，5阶段）— 进行中
  - Phase 1: Dashboard + Logs + Audit Log Detail — 进行中
  - Phase 2: Balance + Usage + Models — 待办
  - Phase 3: Admin 5 页 — 待办
  - Phase 4: Quick Start + MCP Setup + Settings — 待办
  - Phase 5: API Key Insights + Login — 待办
