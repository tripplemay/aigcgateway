...
| 维度 | OpenAI | Claude | DeepSeek | 智谱 AI | 火山引擎 | 硅基流动 | OpenRouter | MiniMax | Moonshot | Qwen | StepFun |
|------|--------|--------|----------|--------|---------|---------|-----------|---------|---------|------|---------|
| 接入方式 | 通用引擎 | 通用引擎 | 通用引擎 | 通用引擎 | 专属Adapter | 专属Adapter | 通用引擎 | 通用引擎(staticModels) | 通用引擎 | 通用引擎 | 通用引擎 |
| 文本 | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |
| 图片 | Y | N | N | Y | Y | Y | Y | N | N | N | N |
| 代理 | 需要 | 需要 | 国内直连 | 国内直连 | 国内直连 | 国内直连 | 需要 | 国内直连 | 国内直连 | 国内直连 | 国内直连 |
| 价格单位 | USD | USD | USD | USD | CNY | CNY | USD | USD | USD | USD | USD |
| /models 含价格 | N | N | N | N | N | N | Y | N(/models 404) | N | N | N |
