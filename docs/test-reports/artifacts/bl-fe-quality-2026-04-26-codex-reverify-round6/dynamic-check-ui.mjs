...
await page.screenshot({ path:`${ART}/dashboard.zhCN.ui.png`, fullPage:true });

await page.goto(`${BASE}/error-test`, { waitUntil:'networkidle' });
await page.waitForTimeout(800);
const errorText = await page.locator('body').innerText();
await page.screenshot({ path:`${ART}/error-test.zhCN.ui.png`, fullPage:true });

await page.goto(`${BASE}/admin/models`, { waitUntil:'networkidle' });
await page.waitForTimeout(1200);
const modelsText = await page.locator('body').innerText();
await page.screenshot({ path:`${ART}/admin-models.zhCN.ui.png`, fullPage:true });
...
await page.screenshot({ path:`${ART}/dashboard-notification.zhCN.ui.png`, fullPage:true });
...
await fs.writeFile(`${ART}/dynamic-evidence.ui.json`, JSON.stringify(out, null, 2));
await browser.close();
