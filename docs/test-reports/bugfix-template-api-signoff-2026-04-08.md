...
**文件：** `scripts/test/_archive_2026Q1Q2/bugfix-template-api-e2e-2026-04-08.ts`（更新 action 引用）；`scripts/test/_archive_2026Q1Q2/p4-action-template-e2e-2026-04-05.ts`（补充 user-level balance / model enable / MCP 工具断言）。
